...
bool QuickSortTests::test_sort_ascending() {
	//set up
	QuickSort sort;
	SortParams params;
...
bool QuickSortTests::test_sort_descending() {
	//set up
	QuickSort sort;
	SortParams params;
...
bool QuickSortTests::test_compare_ascending() {
	//set up
	QuickSort sort;
...
bool QuickSortTests::test_compare_descending() {
	//set up
	QuickSort sort;
