...
bool HybridMergeSortTests::test_sort_ascending() {
	//set up
	HybridMergeSort sort;
	SortParams params;
...
bool HybridMergeSortTests::test_sort_descending() {
	//set up
	HybridMergeSort sort;
	SortParams params;
...
bool HybridMergeSortTests::test_compare_ascending() {
	//set up
	HybridMergeSort sort;
...
bool HybridMergeSortTests::test_compare_descending() {
	//set up
	HybridMergeSort sort;
...
bool HybridMergeSortTests::run_tests() {
