...
bool HybridQuickSortTests::test_sort_ascending() {
	//set up
	HybridQuickSort sort;
	SortParams params;
...
bool HybridQuickSortTests::test_sort_descending() {
	//set up
	HybridQuickSort sort;
	SortParams params;
...
bool HybridQuickSortTests::test_compare_ascending() {
	//set up
	HybridQuickSort sort;
...
bool HybridQuickSortTests::test_compare_descending() {
	//set up
	HybridQuickSort sort;
...
bool HybridQuickSortTests::run_tests() {
